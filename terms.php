...
<section class="w-full max-w-4xl mx-auto px-4 py-16 bg-white my-10 rounded shadow-md border border-gray-200" aria-label="Terms of Use content">
    ...
    <div class="space-y-6 text-slate-700 leading-relaxed text-justify font-sans">
        ...
        <p>Bibliotheca Polascini is a personal, non-commercial website presenting books, chapters, academic publications, and literary works by MUDr. Ľubomír Polaščín, together with related bibliographic information. All content is provided for general informational and educational purposes only.</p>
