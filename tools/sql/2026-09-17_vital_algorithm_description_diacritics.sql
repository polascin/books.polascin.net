-- books.polascin.net: repair mojibake and stripped diacritics in four Vital Algorithm descriptions, 17 September 2026
...
SET description = CASE isbn
  ...
  WHEN 'B0GGJXHQDH' THEN 'Kindle Edition, 2nd edition - January 13, 2026 by Walter Kyo Csoelle (ASIN B0GGJXHQDH, 410 pages). If an algorithm had to choose between saving a wealthy CEO or a beloved kindergarten teacher, how would it decide? Dr. Jana Bravcová returns to Bratislava to join MedCore, where VITAL-7 and the Social Utility Score price patients by economic value. As she uncovers a so-called glitch that was actually murder, she must choose between compliance and stopping the system. Written by Dr. Ľubomír Polaščín, this second edition adds a Developer''s Cut appendix, an updated AI chapter for 2026, a new afterword (''Leaving the Factory''), and a reading group guide.'
  ...
  ELSE description
END
WHERE isbn IN ('B0FFGG4K4D', 'B0GGJXHQDH', '9798243848893', '9798243857475');
